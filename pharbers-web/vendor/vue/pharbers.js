...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "*[data-v-bc5fbb16]{letter-spacing:.4px;line-height:1.6;box-sizing:border-box}.fixed-tabs[data-v-bc5fbb16]{top:80px;height:66px;background-color:#fff!important;position:sticky;z-index:999;display:flex}.fixed-tabs .activity-tabs[data-v-bc5fbb16]{border-bottom:2px solid rgba(22,28,57,.1);margin-bottom:0!important;padding-bottom:0!important;display:flex;align-items:flex-end}.fixed-tabs .activity-tabs .activity-tab[data-v-bc5fbb16]{height:30px;margin-right:24px;line-height:30px;flex:1;display:flex;align-items:flex-start;transform:translateY(-3px);white-space:nowrap;cursor:pointer}.fixed-tabs .activity-tabs .activity-tab[data-v-bc5fbb16]:last-of-type{margin-right:0}.fixed-tabs .activity-tabs .highLight[data-v-bc5fbb16]{border-bottom:2px solid #f5c924;color:#f5c924;padding-bottom:8px}", ""]);
// Exports
module.exports = exports;
