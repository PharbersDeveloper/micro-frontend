...
export default {
    data() {
        return {
            ...
            edit_icon: `${envUrl}` + "/edit_icon.png",
            ...
            dataset_icon: `${envUrl}` + "/normal.svg",
            input_index_icon: `${envUrl}` + "/input_index.svg",
            output_index_icon: `${envUrl}` + "/output_index.svg",
            intermediate_icon: `${envUrl}` + "/intermediate.svg",
            database_icon: `${envUrl}` + "/Database.svg",
            showDialog: false,
            state: '',
            editShow: false,
