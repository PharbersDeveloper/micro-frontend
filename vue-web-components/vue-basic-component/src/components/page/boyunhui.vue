<template>
    <div class="bp-boyunhui">
        ...
        <div ref="position-bluebook">
            <bp-img src="https://components.pharbers.com/dev/offweb/public/img_connect_line.svg" id="position-bluebook"></bp-img>
        </div>
        ...
        <div ref="position-meeting">
            <bp-img src="https://components.pharbers.com/dev/offweb/public/img_connect_line.svg" id="position-meeting"></bp-img>
        </div>
...
<!--                         
        ...
        <div ref="position-speaker">
            <bp-img src="https://components.pharbers.com/dev/offweb/public/img_connect_line.svg" id="position-speaker"></bp-img>
        </div>
        ...
        <div ref="position-cooperation">
            <bp-img src="https://components.pharbers.com/dev/offweb/public/img_connect_line.svg" id="position-cooperation"></bp-img>
        </div>
        ...
        <div ref="position-gallery">
            <bp-img src="https://components.pharbers.com/dev/offweb/public/img_connect_line.svg" id="position-gallery"></bp-img>
        </div>
