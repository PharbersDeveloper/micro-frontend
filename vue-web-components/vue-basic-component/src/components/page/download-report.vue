            ...
            <div v-if="successSubmit" class="submit-success">
                <div class="submit-success-inside-container">
                    <div class="submit-success-header">
                        <bp-img src="https://s3.cn-northwest-1.amazonaws.com.cn/www.pharbers.com/public/icon_success.svg" class="submit-success-img"></bp-img>
                    ...
                    <div class="submit-success-worker-img">
                        <bp-img src="https://s3.cn-northwest-1.amazonaws.com.cn/www.pharbers.com/public/img_qr_staff.jpg"></bp-img>
                    </div>
                    ...
                    <bp-text class="ph-H-Medium submit-success-text">dxfeng@pharbers.com</bp-text>
                </div>
            </div>
