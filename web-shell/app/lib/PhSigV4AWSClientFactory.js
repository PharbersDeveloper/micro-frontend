...
PhSigV4AWSClientFactory.newClient = function (config) {
	...
	awsSigV4Client.accessKey = PhSigV4ClientUtils.assertDefined(
		config.accessKey,
		"accessKey"
	)
	awsSigV4Client.secretKey = PhSigV4ClientUtils.assertDefined(
		config.secretKey,
		"secretKey"
	)
	awsSigV4Client.sessionToken = config.sessionToken
	awsSigV4Client.serviceName = PhSigV4ClientUtils.assertDefined(
		config.serviceName,
		"serviceName"
	)
	awsSigV4Client.region = PhSigV4ClientUtils.assertDefined(
		config.region,
		"region"
	)
	awsSigV4Client.endpoint = PhSigV4ClientUtils.assertDefined(
		config.endpoint,
		"endpoint"
	)
