...
;define("web-shell/adapters/application", ["exports", "ember-inflector", "web-shell/config/environment", "@ember-data/adapter/json-api", "web-shell/lib/PhIamClicent"], function (_exports, _emberInflector, _environment, _jsonApi, _PhIamClicent) {
  ...
  let ApplicationAdapter = (_dec = Ember.inject.service, (_class = class ApplicationAdapter extends _jsonApi.default {
    ...
    pathForType(type) {
      let typeArray = _environment.default.APP.typeArray; // if(type === "account" || type === "role" || type === "scope") {
      // 	this.authType = "oauth"
...
;define("web-shell/components/ph-pnt-layout", ["exports", "@glimmer/component"], function (_exports, _component) {
  "use strict";
  ...
  */
  ...
  let PhPntLayoutComponent = (_dec = Ember.inject.service, _dec2 = Ember.inject.service, _dec3 = Ember._tracked, _dec4 = Ember._tracked, _dec5 = Ember._action, _dec6 = Ember._action, _dec7 = Ember._action, (_class = class PhPntLayoutComponent extends _component.default {
    constructor(...args) {
      super(...args);
      ...
      _initializerDefineProperty(this, "projectName", _descriptor3, this);
    ...
    writable: true,
    initializer: null
  }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "projectName", [_dec3], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "projectId", [_dec4], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _applyDecoratedDescriptor(_class.prototype, "listener", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "listener"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "registerListener", [_dec6], Object.getOwnPropertyDescriptor(_class.prototype, "registerListener"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "unregisterListener", [_dec7], Object.getOwnPropertyDescriptor(_class.prototype, "unregisterListener"), _class.prototype)), _class));
...
;define("web-shell/routes/oauth-callback", ["exports"], function (_exports) {
  ...
  let OauthCallbackRoute = (_dec = Ember.inject.service, _dec2 = Ember.inject.service, (_class = class OauthCallbackRoute extends Ember.Route {
    constructor(...args) {
      super(...args);
