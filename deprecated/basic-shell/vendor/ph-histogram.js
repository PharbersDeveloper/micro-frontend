...
// Module
exports.push([module.i, ".viewport[data-v-15cd8a4c]{overflow:auto}", ""]);
// Exports
...
// load the styles
var content = __webpack_require__("04c1");
...
module.exports.__inject__ = function (shadowRoot) {
  add("798f8de3", content, shadowRoot)
};
...
__webpack_require__.d(d3_src_namespaceObject, "descending", function() { return descending; });
__webpack_require__.d(d3_src_namespaceObject, "deviation", function() { return deviation; });
__webpack_require__.d(d3_src_namespaceObject, "extent", function() { return extent_extent; });
...
__webpack_require__.d(d3_src_namespaceObject, "bin", function() { return bin_bin; });
__webpack_require__.d(d3_src_namespaceObject, "histogram", function() { return bin_bin; });
__webpack_require__.d(d3_src_namespaceObject, "thresholdFreedmanDiaconis", function() { return thresholdFreedmanDiaconis; });
__webpack_require__.d(d3_src_namespaceObject, "thresholdScott", function() { return thresholdScott; });
__webpack_require__.d(d3_src_namespaceObject, "thresholdSturges", function() { return thresholdSturges; });
...
__webpack_require__.d(d3_src_namespaceObject, "mode", function() { return mode_mode; });
...
__webpack_require__.d(d3_src_namespaceObject, "range", function() { return range_range; });
__webpack_require__.d(d3_src_namespaceObject, "rank", function() { return rank; });
...
__webpack_require__.d(d3_src_namespaceObject, "ticks", function() { return ticks_ticks; });
...
__webpack_require__.d(d3_src_namespaceObject, "transpose", function() { return transpose_transpose; });
...
__webpack_require__.d(d3_src_namespaceObject, "dispatch", function() { return src_dispatch; });
...
__webpack_require__.d(d3_src_namespaceObject, "interpolateArray", function() { return src_array; });
...
__webpack_require__.d(d3_src_namespaceObject, "link", function() { return link_link; });
...
__webpack_require__.d(d3_src_namespaceObject, "symbol", function() { return symbol_Symbol; });
__webpack_require__.d(d3_src_namespaceObject, "symbolsStroke", function() { return symbolsStroke; });
__webpack_require__.d(d3_src_namespaceObject, "symbolsFill", function() { return symbolsFill; });
__webpack_require__.d(d3_src_namespaceObject, "symbols", function() { return symbolsFill; });
__webpack_require__.d(d3_src_namespaceObject, "symbolAsterisk", function() { return asterisk; });
...
__webpack_require__.d(d3_src_namespaceObject, "symbolDiamond2", function() { return diamond2; });
__webpack_require__.d(d3_src_namespaceObject, "symbolPlus", function() { return plus; });
__webpack_require__.d(d3_src_namespaceObject, "symbolSquare", function() { return symbol_square; });
__webpack_require__.d(d3_src_namespaceObject, "symbolSquare2", function() { return square2; });
...
__webpack_require__.d(d3_src_namespaceObject, "symbolTriangle2", function() { return triangle2; });
__webpack_require__.d(d3_src_namespaceObject, "symbolWye", function() { return wye; });
__webpack_require__.d(d3_src_namespaceObject, "symbolX", function() { return symbol_x; });
...
__webpack_require__.d(d3_src_namespaceObject, "now", function() { return now; });
__webpack_require__.d(d3_src_namespaceObject, "timer", function() { return timer; });
__webpack_require__.d(d3_src_namespaceObject, "timerFlush", function() { return timerFlush; });
__webpack_require__.d(d3_src_namespaceObject, "timeout", function() { return src_timeout; });
__webpack_require__.d(d3_src_namespaceObject, "interval", function() { return src_interval; });
...
function bin_bin() {
  ...
  function histogram(data) {
    ...
    if (!Array.isArray(tz)) {
      const max = x1, tn = +tz;
      if (domain === extent_extent) [x0, x1] = nice(x0, x1, tn);
      tz = ticks_ticks(x0, x1, tn);
      ...
      if (tz[tz.length - 1] >= x1) {
        if (max >= x1 && domain === extent_extent) {
...
function mode_mode(values, valueof) {
...
function zip() {
  return transpose_transpose(arguments);
}
...
var src_array_slice = d3_contour_src_array_array.slice;
...
/* harmony default export */ var src_contours = (function() {
  ...
  function contours(values) {
    ...
    if (!Array.isArray(tz)) {
      const e = extent_extent(values), ts = tickStep(e[0], e[1], tz);
      tz = ticks_ticks(Math.floor(e[0] / ts) * ts, Math.floor(e[1] / ts - 1) * ts, tz);
    } else {
...
/* harmony default export */ var src_density = (function() {
  ...
  function density(data) {
    ...
    if (!Array.isArray(tz)) {
      ...
      tz = range_range(0, Math.floor(stop / tz) * tz, tz);
      tz.shift();
    }
...
function longitude(point) {
  return src_math_abs(point[0]) <= math_pi ? point[0] : math_sign(point[0]) * ((src_math_abs(point[0]) + math_pi) % math_tau - math_pi);
}
...
function graticuleX(y0, y1, dy) {
  var y = range_range(y0, y1 - src_math_epsilon, dy).concat(y1);
  return function(x) { return y.map(function(y) { return [x, y]; }); };
}

function graticuleY(x0, x1, dx) {
  var x = range_range(x0, x1 - src_math_epsilon, dx).concat(x1);
...
function graticule_graticule() {
  ...
  function lines() {
    return range_range(ceil(X0 / DX) * DX, X1, DX).map(X)
        .concat(range_range(ceil(Y0 / DY) * DY, Y1, DY).map(Y))
        .concat(range_range(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return src_math_abs(x % DX) > src_math_epsilon; }).map(x))
        .concat(range_range(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return src_math_abs(y % DY) > src_math_epsilon; }).map(y));
  }
...
const star_kx = src_math_sin(src_math_tau / 10) * kr;
const star_ky = -src_math_cos(src_math_tau / 10) * kr;
...
/* harmony default export */ var symbol_x = ({
  draw(context, size) {
...
// CONCATENATED MODULE: ./src/components/model/datasource.js
class PhDagDatasource {
  constructor(id) {
    this.id = id;
    this.data = [];
  }
...
/* harmony default export */ var histogramvue_type_script_lang_js_shadow = ({
  data: () => {
    return {
      name: "histogram",
      needRefresh: 0
  ...
  props: {
    ...
    d3: {
      type: Object,
      default: function () {
        return Object.assign({}, d3_src_namespaceObject);
      }
    }
  },
  ...
  destroyed() {// 注意移除监听！注意移除监听！注意移除监听！
  ...
  methods: {
    async initChart() {
      // 初始化echarts实例
      await this.datasource.refreshData(this); // 发布前解注
    ...
    renderBarChart(data, {
      ...
      const d3 = this.d3; // Compute values.

      const X = d3.map(data, x);
      const Y = d3.map(data, y); // Compute default domains, and unique the x-domain.

      if (xDomain === undefined) xDomain = X;
      if (yDomain === undefined) yDomain = [0, d3.max(Y)];
      xDomain = new d3.InternSet(xDomain); // Omit any data not present in the x-domain.

      const I = d3.range(X.length).filter(i => xDomain.has(X[i])); // Construct scales, axes, and formats.

      const xScale = d3.scaleBand(xDomain, xRange).padding(xPadding);
      const yScale = yType(yDomain, yRange);
      const xAxis = d3.axisBottom(xScale).tickSizeOuter(0);
      const yAxis = d3.axisLeft(yScale).ticks(height / 40, yFormat); // Compute titles.
      ...
      const svg = d3.select(this.$refs.chart).append("svg").attr("width", width).attr("height", height).attr("viewBox", [0, 0, width, height]).attr("style", "max-width: 100%; height: auto; height: intrinsic;");
  ...
  watch: {
    needRefresh(n, o) {
      this.renderBarChart(this.datasource.data, {
        x: d => d.letter,
        y: d => d.frequency,
        xDomain: this.d3.groupSort(this.datasource.data, ([d]) => -d.frequency, d => d.letter),
...
var component = normalizeComponent(
  components_histogramvue_type_script_lang_js_shadow,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var histogramshadow = (component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"9ff4b838-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/vue-svg-inline-loader/src!./src/components/testcomponentv2.vue?vue&type=template&id=9b981c76&scoped=true&shadow
var testcomponentv2vue_type_template_id_9b981c76_scoped_true_shadow_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('h2',[_vm._v("test components")])}
var testcomponentv2vue_type_template_id_9b981c76_scoped_true_shadow_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/testcomponentv2.vue?vue&type=template&id=9b981c76&scoped=true&shadow

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/vue-svg-inline-loader/src!./src/components/testcomponentv2.vue?vue&type=script&lang=js&shadow
//
//
//
/* harmony default export */ var testcomponentv2vue_type_script_lang_js_shadow = ({
  data: () => {
    return {
      name: "test component",
      needRefresh: 0
...
var testcomponentv2shadow_component = normalizeComponent(
  components_testcomponentv2vue_type_script_lang_js_shadow,
  testcomponentv2vue_type_template_id_9b981c76_scoped_true_shadow_render,
  testcomponentv2vue_type_template_id_9b981c76_scoped_true_shadow_staticRenderFns,
  false,
  testcomponentv2shadow_injectStyles,
  "9b981c76",
  null
  ,true
)

/* harmony default export */ var testcomponentv2shadow = (testcomponentv2shadow_component.exports);
...
window.customElements.define('ph-histogram-histogram', vue_wc_wrapper(external_Vue_default.a, histogramshadow))


window.customElements.define('ph-histogram-testcomponentv2', vue_wc_wrapper(external_Vue_default.a, testcomponentv2shadow))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_vue_svg_inline_loader_src_index_js_histogram_vue_vue_type_style_index_0_id_15cd8a4c_scoped_true_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("478f");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_vue_svg_inline_loader_src_index_js_histogram_vue_vue_type_style_index_0_id_15cd8a4c_scoped_true_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_vue_svg_inline_loader_src_index_js_histogram_vue_vue_type_style_index_0_id_15cd8a4c_scoped_true_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_vue_svg_inline_loader_src_index_js_histogram_vue_vue_type_style_index_0_id_15cd8a4c_scoped_true_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_vue_svg_inline_loader_src_index_js_histogram_vue_vue_type_style_index_0_id_15cd8a4c_scoped_true_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ })

/******/ });
//# sourceMappingURL=ph-histogram.js.map